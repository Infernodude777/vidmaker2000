...
SHORTCUTS = [
    ...
    {"key": ",", "action": "frame_back", "group": "Playback",
     "desc": "Step back one frame"},
    {"key": ".", "action": "frame_fwd", "group": "Playback",
     "desc": "Step forward one frame"},
    {"key": "shift+j", "action": "speed_down", "group": "Playback",
     "desc": "Slower playback"},
    {"key": "shift+l", "action": "speed_up", "group": "Playback",
    ...
    {"key": "g", "action": "goto", "group": "Project",
     "desc": "Focus the go-to-timecode field"},
    {"key": "p", "action": "snapshot", "group": "Project",
     "desc": "Save the current frame as a PNG"},
    ...
    {"key": "b", "action": "marker", "group": "Markers",
     "desc": "Drop a marker at the playhead"},
    {"key": "up", "action": "marker_prev", "group": "Markers",
     "desc": "Jump to the previous marker"},
    {"key": "down", "action": "marker_next", "group": "Markers",
     "desc": "Jump to the next marker"},
    {"key": "[", "action": "fade_in", "group": "Markers",
     "desc": "Cycle fade-in on the selected clip"},
    {"key": "]", "action": "fade_out", "group": "Markers",
     "desc": "Cycle fade-out on the selected clip"},
]
